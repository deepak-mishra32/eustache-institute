  ...
  return (
    <Row className="mt-2">
      <Col Col sm={12} md={12} lg={12}>
        ...
        <Form.Check
          checked={details.concerns.includes("Lax/Bulging abdomen")}
          disabled={
            !details.concerns.includes("Lax/Bulging abdomen") &&
            details.concerns.length > 1
          }
          label="Lax/Bulging abdomen"
          name={details.bodyPart}
          value="Lax/Bulging abdomen"
          onClick={onChangehandler}
        />
        <Form.Check
          checked={details.concerns.includes("Muffin Top")}
          disabled={
            !details.concerns.includes("Muffin Top") &&
            details.concerns.length > 1
          }
          label="Muffin Top"
          name={details.bodyPart}
